...
using allocStackExt_t = hfog::Alloc::StackExt<alignment, hfog::GarbageWriter::ByteWriter<0xFA, 0xAF>>;

template<mem_t alignment, mem_t bytes>
using allocStack_t = hfog::Alloc::Stack<alignment, bytes, hfog::GarbageWriter::ByteWriter<0xFA, 0xAF>>;

template<mem_t alignment, mem_t maxAllocBytes, size_t numOfChunks>
using allocIslandsExt_t = hfog::Alloc::IslandsExt<alignment, maxAllocBytes, numOfChunks, hfog::GarbageWriter::ByteWriter<0xFA, 0xAF>>;

template<mem_t alignment, mem_t maxAllocBytes, size_t numOfChunks>
using allocIslands_t = hfog::Alloc::Islands<alignment, maxAllocBytes, numOfChunks, hfog::GarbageWriter::ByteWriter<0xFA, 0xAF>>;


template<mem_t alignment, size_t numOfChunks>
using allocPoolExt_t = hfog::Alloc::PoolExt<alignment, numOfChunks, hfog::GarbageWriter::ByteWriter<0xFA, 0xAF>>;

template<mem_t alignment, size_t numOfChunks>
using allocPool_t = hfog::Alloc::Pool<alignment, numOfChunks, hfog::GarbageWriter::ByteWriter<0xFA, 0xAF>>;
